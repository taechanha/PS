...
# Dev-Matching: Silicon Valley 코딩테스트 for hatc
# 감독관 채팅
# 메시지 보관함
# 도움말
# Python3 레퍼런스
...
# ["azad", "andy", "louis", "will", "edward"][[3, 4], [-1, 5], [-4, 4],
#                                             [3, 4], [-5, 0]][4.19, 3.77, 4.41, 3.65, 3.58][2, 3, 1, 5, 4]
# ["clanguage", "csharp", "java", "python"][[3, -3], [-2, 7],
#                                           [-1, -1], [5, 4]][1.27, 4.31, 4.26, 3.99][4, 1, 2, 3]
...
# 2
# return sorted(range(len(names)), key=lambda k: (grades[k], -homes[k][0], -homes[k][1], names[k]))
# 실행 결과
# 실행 결과가 여기에 표시됩니다.
# 종료까지
# 00: 00: 53
